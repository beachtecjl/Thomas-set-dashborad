...
### Importing XLSX
- Click **Import XLSX** (header) or **Upload XLSX** inside the Add Set modal and choose a `.xlsx`/`.xls` file.
...
- If present, columns `1`, `2`, `3`, `4` (or rankA..rankD equivalents) are used for ranks A–D; otherwise ranks default to 0.
